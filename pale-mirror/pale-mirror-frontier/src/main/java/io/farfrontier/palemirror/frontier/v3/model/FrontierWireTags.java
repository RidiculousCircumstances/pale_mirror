...
public final class FrontierWireTags {
    private static final Map<Class<?>, Map<Integer, ? extends Enum<?>>> BY_TYPE = Map.ofEntries(
            ...
            entry(AmbientGoalKind.class,
                    ...
                    tag(7, AmbientGoalKind.HIVE_TASK_ASSEMBLY)),
            ...
            entry(BioformChassis.class,
                    tag(10, BioformChassis.RUNT), tag(11, BioformChassis.OVERSEER), tag(12, BioformChassis.SENTINEL)),
            entry(BioformMutation.class,
                    tag(10, BioformMutation.EXPLOSIVE), tag(11, BioformMutation.MUCUS), tag(12, BioformMutation.ARMORED),
                    tag(13, BioformMutation.SPORE), tag(14, BioformMutation.CARRIER)),
            entry(BioformAssignment.class,
                    tag(10, BioformAssignment.WATCH), tag(11, BioformAssignment.SCOUT), tag(12, BioformAssignment.HARVEST),
                    tag(13, BioformAssignment.CARRY), tag(14, BioformAssignment.REPAIR), tag(15, BioformAssignment.DEFEND),
                    tag(16, BioformAssignment.ASSAULT), tag(17, BioformAssignment.SIEGE), tag(18, BioformAssignment.RETREAT)),
            ...
            entry(GrayboxSemanticPart.class,
                    ...
                    tag(7, GrayboxSemanticPart.WORKSITE_STAGING), tag(8, GrayboxSemanticPart.ROUTE_FOUNDATION), tag(9, GrayboxSemanticPart.COCOON),
                    tag(10, GrayboxSemanticPart.WORKSHOP_INPUT_STATION), tag(11, GrayboxSemanticPart.WORKSHOP_PROCESS_STATION)),
            entry(BioformLifecyclePhase.class,
                    tag(10, BioformLifecyclePhase.DORMANT), tag(11, BioformLifecyclePhase.WAKING), tag(12, BioformLifecyclePhase.ASSEMBLING),
                    tag(13, BioformLifecyclePhase.ACTIVE), tag(14, BioformLifecyclePhase.RETURNING), tag(15, BioformLifecyclePhase.RECOVERING)),
            ...
            entry(HiveCommandAuthorityKind.class,
                    tag(0, HiveCommandAuthorityKind.RELAY), tag(1, HiveCommandAuthorityKind.OVERSEER)),
            entry(HiveCommandSignalPhase.class,
                    tag(0, HiveCommandSignalPhase.CONNECTED), tag(1, HiveCommandSignalPhase.SIGNAL_MEMORY),
                    tag(2, HiveCommandSignalPhase.INSTINCT), tag(3, HiveCommandSignalPhase.RECLAIMED)),
            entry(RouteMaintenanceStatus.class,
                    tag(0, RouteMaintenanceStatus.BUILDING), tag(1, RouteMaintenanceStatus.READY), tag(2, RouteMaintenanceStatus.CONFLICT)),
            ...
            entry(HiveOrganKind.class,
                    tag(10, HiveOrganKind.GANGLION), tag(11, HiveOrganKind.RELAY), tag(12, HiveOrganKind.STORE),
                    tag(13, HiveOrganKind.DIGESTER), tag(14, HiveOrganKind.BROOD), tag(15, HiveOrganKind.HIBERNACULUM),
                    tag(16, HiveOrganKind.MORPHER), tag(17, HiveOrganKind.SPORULATOR), tag(18, HiveOrganKind.SENSOR)),
            ...
            entry(MedicalEvacuationStatus.class,
                    tag(0, MedicalEvacuationStatus.PREPARED), tag(1, MedicalEvacuationStatus.TREATING),
                    tag(2, MedicalEvacuationStatus.COMPLETED), tag(3, MedicalEvacuationStatus.BLOCKED),
                    tag(4, MedicalEvacuationStatus.UNKNOWN_AFTER_RESTART)),
            ...
            entry(PhysicalIntentKind.class,
                    ...
                    tag(15, PhysicalIntentKind.EQUIPMENT_RETURN), tag(16, PhysicalIntentKind.ROUTE_MAINTENANCE),
                    tag(17, PhysicalIntentKind.ROUTE_MAINTENANCE_MATERIAL_LOADING), tag(18, PhysicalIntentKind.SETTLEMENT_SERVICE_INPUT_ISSUE)),
            ...
            entry(PhysicalPostcondition.class,
                    ...
                    tag(14, PhysicalPostcondition.EQUIPMENT_ISSUED_OBSERVED), tag(15, PhysicalPostcondition.EQUIPMENT_RETURNED_OBSERVED),
                    ...
                    tag(18, PhysicalPostcondition.SETTLEMENT_SERVICE_INPUT_ISSUED_OBSERVED)),
            ...
            entry(RoutePatrolStatus.class,
                    tag(0, RoutePatrolStatus.ASSEMBLING), tag(1, RoutePatrolStatus.EN_ROUTE), tag(2, RoutePatrolStatus.ROUTE_CLEAR),
                    tag(3, RoutePatrolStatus.OBSTRUCTION_CONFIRMED), tag(4, RoutePatrolStatus.BLOCKED), tag(5, RoutePatrolStatus.FAILED)),
            entry(RouteUnitDuty.class,
                    tag(0, RouteUnitDuty.PATROL_LEADER), tag(1, RouteUnitDuty.SCOUT), tag(2, RouteUnitDuty.CARGO_CREW), tag(3, RouteUnitDuty.ESCORT)),
            entry(RouteUnitKind.class,
                    tag(0, RouteUnitKind.PATROL), tag(1, RouteUnitKind.CARGO_ESCORT)),
            ...
            entry(StrategicTaskRequirement.class,
                    ...
                    tag(2, StrategicTaskRequirement.OPERATIONAL_GANGLION), tag(3, StrategicTaskRequirement.AVAILABLE_HIVE_GUARD), tag(4, StrategicTaskRequirement.EXACT_HIVE_BIOMASS),
