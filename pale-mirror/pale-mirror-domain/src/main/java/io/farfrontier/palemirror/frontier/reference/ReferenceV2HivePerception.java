...
/** Bounded sector beliefs held by the hive mind. */
public final class ReferenceV2HivePerception {
    ...
    public List<ReferenceV2Belief> known(int day) {
        ...
        for (ReferenceV2Belief belief : beliefs.values()) {
            ReferenceV2Belief decayed = belief.decayed(day, ReferenceV2Rules.HIVE_DECAY_PER_DAY);
