...
## Working set
- Workspace `../AGENTS.md`; `AGENTS.md`, `CONTINUITY.md`, `tools/engineering/continuity_ledger.py`, `architecture.yml`, `docs/living-frontier-0.3-release-audit.md`; next work is live 0.3 product validation and the decision-complete 0.4 autonomous-economy design.
