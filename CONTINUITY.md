...
- The corrected PM JAR and exact Railway Untold fork are checksum-published and installed on the private server with managed mode enabled. A fresh v25 world is running with both Create and managed-railway adapters `AVAILABLE`; the preceding v24 test world is archived.
