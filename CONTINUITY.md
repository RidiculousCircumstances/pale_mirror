...
- Operation cargo now has a physical-collision GameTest: its deterministic owned chest-minecart makes bounded partial progress toward the source anchor, cannot tunnel through a real wall, and retains both its exact identity and owned stack. The full critical gate passed with 152/152 NeoForge GameTests.
