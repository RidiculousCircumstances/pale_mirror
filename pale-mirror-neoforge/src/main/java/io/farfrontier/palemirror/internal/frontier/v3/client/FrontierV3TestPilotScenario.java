...
final class FrontierV3TestPilotScenario {
    ...
    private static final Set<String> DIAGNOSTIC_VIEWS = Set.of("summary", "site", "settlement", "hive", "actor", "item", "container", "operation", "route_construction", "physical_delta", "scene", "intent", "trace");
