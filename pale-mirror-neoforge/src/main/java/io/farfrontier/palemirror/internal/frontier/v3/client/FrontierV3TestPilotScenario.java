...
final class FrontierV3TestPilotScenario {
    ...
    private static final Set<String> DIAGNOSTIC_VIEWS = Set.of(
            "summary", "performance", "site", "settlement", "hive", "hive_transfer", "actor", "item", "container", "market_order", "operation",
            "route_construction", "route_maintenance", "route_topology", "physical_delta", "scene", "intent", "trace", "transit", "medical", "traversal_foundry");
