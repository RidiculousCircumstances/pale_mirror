...
final class FrontierV3PhysicalExecutors {
    private static final FrontierV3PhysicalExecutorRegistry REGISTRY = new FrontierV3PhysicalExecutorRegistry(List.of(
            ...
            executor("defender-equipment-return", FrontierV3PhysicalExecutorRegistry.Stage.EFFECT, Set.of("settlement-service-input-issue"), "defender-equipment-return-effect", FrontierV3EquipmentReturnExecutor::tick),
