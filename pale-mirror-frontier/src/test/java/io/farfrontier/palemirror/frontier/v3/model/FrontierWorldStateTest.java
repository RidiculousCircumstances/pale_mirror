...
class FrontierWorldStateTest {
    ...
    void codecRoundTripsCanonicalMutableStateAndRejectsInvalidState() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new FrontierWorldState(source.bootstrap(), missingActor,
                ...
                source.physicalObservations(), source.sceneLeases(), source.hiveColony(), source.structureDamage(), source.physicalDeltas(), source.ambientLeases(), source.routeConstructions(), source.routeTopology(), source.strategicPlans()));
    }
