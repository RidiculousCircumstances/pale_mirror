...
record SettlementQuarantineTransition(SubjectId settlementId, SettlementQuarantineStatus status, long atTick) implements FrontierPayload {
    SettlementQuarantineTransition {
