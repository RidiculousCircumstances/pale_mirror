...
public record HiveGrowthJob(SubjectId id, SubjectId hiveId, SubjectId nestId, SubjectId consumedItemId,
    ...
    public HiveGrowthJob {
        ...
        Objects.requireNonNull(nestId, "nest id"); Objects.requireNonNull(consumedItemId, "consumed item id");
