...
record RouteEngagementAttackerAdvanced(SubjectId engagementId, SubjectId attackerId, int routeIndex) implements FrontierPayload {
    RouteEngagementAttackerAdvanced {
