...
public record AmbientLeaseReleased(SubjectId actorId, BodyPosition body, FixedScalar health) implements FrontierPayload {
    public AmbientLeaseReleased {
        Objects.requireNonNull(actorId, "actor id"); Objects.requireNonNull(body, "body"); Objects.requireNonNull(health, "health");
