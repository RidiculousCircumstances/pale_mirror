...
record SettlementAssaultSceneLeaseHandoff(SceneLease lease, List<SceneMemberPosition> ambientMembers) implements FrontierPayload {
    SettlementAssaultSceneLeaseHandoff {
