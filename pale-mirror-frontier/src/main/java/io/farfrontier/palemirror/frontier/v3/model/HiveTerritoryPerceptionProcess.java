...
final class HiveTerritoryPerceptionProcess {
    ...
    static FrontierWorldState reduce(FrontierWorldState state, SubjectId subject, HiveTerritoryObserved observed) {
    ...
    record Refresh(HiveTerritoryKnowledge knowledge, List<ProposedEvent> events) { }
}
