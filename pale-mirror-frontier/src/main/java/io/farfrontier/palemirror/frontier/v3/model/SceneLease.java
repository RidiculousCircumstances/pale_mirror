...
public record SceneLease(SceneLeaseId id, SubjectId operationId, SubjectId cargoId, BlockPosition handoffPosition,
    ...
    public SceneLease(SceneLeaseId id, SubjectId operationId, SubjectId cargoId, BlockPosition handoffPosition,
                      SimInstant handoffInstant, long revision, SceneLeaseStatus status, List<SceneMember> members) {
        this(id, operationId, cargoId, handoffPosition, handoffInstant, revision, status, Optional.empty(), members);
    }
    ...
    public SceneLease withStatus(SceneLeaseStatus nextStatus) {
        return new SceneLease(id, operationId, cargoId, handoffPosition, handoffInstant, revision, nextStatus, engagementId, members);
    }
}
