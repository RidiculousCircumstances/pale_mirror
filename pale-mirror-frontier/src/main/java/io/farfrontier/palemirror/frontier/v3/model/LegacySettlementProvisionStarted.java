 ...
 */
public record LegacySettlementProvisionStarted(SubjectId settlementId, int cycleOrdinal, long startedAtTick, int requiredRations,
    ...
    public record LegacyAllocation(SubjectId itemId, int count) {
        public LegacyAllocation {
    ...
    public LegacySettlementProvisionStarted {
