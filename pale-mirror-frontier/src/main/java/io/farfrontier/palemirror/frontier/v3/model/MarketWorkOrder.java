...
record MarketWorkOrder(SubjectId id, SubjectId demandId, SubjectId quoteId, SubjectId sellerId, SubjectId taskId,
    ...
    MarketWorkOrder {
        ...
        Objects.requireNonNull(taskId, "market work order task"); Objects.requireNonNull(reservationId, "market work order reservation");
    ...
    MarketWorkOrder withStatus(MarketWorkOrderStatus next) {
        return new MarketWorkOrder(id, demandId, quoteId, sellerId, taskId, reservationId, acceptedTotalPrice, next);
    }
}
