...
public record SceneEngagementCandidate(SubjectId engagementId, SubjectId operationId, SubjectId cargoId,
                                      BlockPosition handoffPosition, List<SubjectId> actorIds) {
    public SceneEngagementCandidate {
        ...
        Objects.requireNonNull(cargoId, "cargo id"); Objects.requireNonNull(handoffPosition, "handoff position"); actorIds = List.copyOf(actorIds);
