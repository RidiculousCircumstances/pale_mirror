...
record SettlementInfectionObserved(SubjectId settlementId, InfectionCell cell, FixedRatio intensity, long observedAt) implements FrontierPayload {
    SettlementInfectionObserved {
