 ...
 */
final class HumanHealthProcess {
    static final long PROGRESSION_DELAY = 1_200L;
    ...
    static List<ProposedEvent> assess(FrontierWorldState state, Settlement settlement, long now) {
    ...
    static FrontierWorldState reduceResidentTransition(FrontierWorldState state, SubjectId subject, long eventTick, ResidentHealthTransition transition) {
    ...
    static FrontierWorldState reduceQuarantineTransition(FrontierWorldState state, SubjectId subject, long eventTick, SettlementQuarantineTransition transition) {
