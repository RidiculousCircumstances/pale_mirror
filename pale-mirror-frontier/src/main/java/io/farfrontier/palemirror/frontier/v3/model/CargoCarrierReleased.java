 ...
 */
public record CargoCarrierReleased(SceneLeaseId leaseId, SubjectId cargoId, UUID carrierId, UUID observerPlayerId) implements FrontierPayload {
    public CargoCarrierReleased {
        ...
        Objects.requireNonNull(observerPlayerId, "observer player id");
    }
