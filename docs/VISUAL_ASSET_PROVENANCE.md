...
| Harvester creature models and textures | User-provided reference images; OpenAI image generation, project-directed | generated and art-refined 2026-08-21 | n/a | Resource-only GeckoLib assets for Biomass Collector, Crusher Stalker and Scythe Stalker, rebuilt from project-owned 1254×1254 hi-fi mesh sources as segmented cuboids with original textures/animations; editable v2 material studies are retained with the sources; SRP was inspected only for a non-retained cuboid-chain technique; no entity/runtime registration in this cut |
